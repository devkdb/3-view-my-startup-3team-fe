...
function InvestStatusDropdownList({ onItemClick, dropdownRef, onItemSort }) {
  ...
  return (
    ...
    >
      <li
        ...
        onClick={() => 
          onItemClick("simInvestDesc","View My Startup 투자 금액 높은순")}
      >
      ...
      <li
        className="DropdownListFont"
        onClick={() => 
          onItemClick("simInvestAsc", "View My Startup 투자 금액 낮은순")}
      >
